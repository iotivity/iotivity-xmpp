...
namespace rapidxml
{
    ...
    namespace internal
    {
        ...
        //To fix build error, we used the following lines based on input from
        //http://stackoverflow.com/questions/14113923/rapidxml-print-header-has-undefined-methods
        //changed the rapidxml_print.hpp header to have the following right before the declaration
        // of the print_node function (in my file, I inserted this right after line 104):
